...
ActiveRecord::Schema[8.1].define(version: 2026_05_01_113312) do
  ...
  create_table "appointment_requests", force: :cascade do |t|
    ...
    t.index ["nutritionist_id", "status", "requested_at"], name: "idx_on_nutritionist_id_status_requested_at_9579e8a2d3"
  ...
  create_table "availability_slots", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["nutritionist_id", "day_of_week"], name: "index_availability_slots_on_nutritionist_id_and_day_of_week", unique: true
    t.index ["nutritionist_id"], name: "index_availability_slots_on_nutritionist_id"
  end
  ...
  add_foreign_key "availability_slots", "nutritionists"
